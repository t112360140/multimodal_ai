...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        download_btn.setOnClickListener { view ->
            ...
            val model_name = resources.getStringArray(R.array.models_name)[position]
            val model_path = resources.getStringArray(R.array.models_path)[position]
            val model_url = resources.getStringArray(R.array.models_url)[position]
